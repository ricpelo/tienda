...
-- ARTICULOS --
    ...
    insert into articulos (codigo, descripcion, precio, existencias)
        values  (2887942650087,'Portátil Lenovo 13,3" YOGA 2 Pro-13 i7 4500U',480.00,3),
                (4713147445028,'Portátil Acer 15,6" Aspire E5-571 i5 4210U',456.00,1),
                (3888182856291,'Portátil HP 17" Pavilion 17-e104ss i7 4702MQ',899.99,1),
                (8433556543445,'Disco duro Seagate Exp. 2 TB - 2,5", USB 3.0',80.00,2),
                (8433326765499,'Monitor ACER 27" 2560x1980 pix. 3D',255.00,2),
                (8456555874556,'Smartphone libre Sony Xperia T3 violeta',299.99,1),
                ...
                (8433478555452,'Proyector LG PB62G, 3D Ready, HDMI y USB DivXHD',499.00,1),
                (8458965856666,'eReader Sony PRS-T3 elink 6'' táctil WiFi rojo',299.99,1),
                (8124587454663,'La Tierra Media: Sombras De Mordor Pc',43.00,1),
